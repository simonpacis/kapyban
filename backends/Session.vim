...
silent only
silent tabonly
cd ~/Documents/Dev/Kanpyban/backends
...
badd +56 nodejs/kapyban.js
badd +54 nodejs/readme.md
badd +0 python/kapyban.py
argglobal
%argdel
edit python/kapyban.py
...
silent! normal! zE
let &fdl = &fdl
let s:l = 85 - ((54 * winheight(0) + 27) / 55)
